...
Seleccionar uma pasta de run existente e correr só Reconciliar e/ou Interpretar — útil após corrigir manualmente um `inferred_answer_key.csv` ou `manual_answer_key.csv`.
